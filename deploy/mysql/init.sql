...
('BookHive 东京秋叶原店', '位于秋叶原电器街的旗舰书店，专营动漫、轻小说和技术书籍', '东京都千代田区外神田1-15-1', '东京', '千代田区', '03-1234-5678', ST_GeomFromText('POINT(35.6985 139.7711)', 4326), '10:00-21:00'),
('BookHive 东京池袋店', '池袋最大的综合书店，涵盖各类书籍', '东京都丰岛区东池袋1-1-1', '东京', '丰岛区', '03-2345-6789', ST_GeomFromText('POINT(35.7295 139.7109)', 4326), '10:00-22:00'),
('BookHive 大阪难波店', '难波商圈核心书店', '大阪府大阪市中央区难波5-1-1', '大阪', '中央区', '06-1234-5678', ST_GeomFromText('POINT(34.6659 135.5014)', 4326), '10:00-21:00'),
('BookHive 名古屋店', '名古屋站前综合书店', '爱知县名古屋市中村区名�的1-1-1', '名古屋', '中村区', '052-123-4567', ST_GeomFromText('POINT(35.1709 136.8826)', 4326), '10:00-20:00'),
('BookHive 北京三里屯店', '三里屯文化创意书店', '北京市朝阳区三里屯路19号', '北京', '朝阳区', '010-12345678', ST_GeomFromText('POINT(39.9339 116.4551)', 4326), '09:00-22:00'),
('BookHive 上海南京路店', '南京路步行街旗舰店', '上海市黄浦区南京东路100号', '上海', '黄浦区', '021-12345678', ST_GeomFromText('POINT(31.2435 121.4868)', 4326), '09:00-22:00');
